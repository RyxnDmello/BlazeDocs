...
export default function Tool({ url, icon, label, description }: ToolProps) {
  return (
    <Link
      className="group relative grid w-[365px] grid-cols-1 items-stretch justify-stretch rounded-md border-2 border-white/[20%] p-1 transition-all hover:border-white/[30%]"
      href={url}
    >
